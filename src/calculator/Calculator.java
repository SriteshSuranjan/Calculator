...
public class Calculator extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(112, 64, 117));
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        String percent = jTextField1.getText();
        double num = Double.parseDouble(percent);
        jTextField1.setText((num/100)+"");
    ...
    private void jButton15ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton15ActionPerformed
        ...
        if(operator.equals("+")){
            jTextField1.setText((number1 + number2) + "");
        }
        ...
        {
            jTextField1.setText((number1/100)+"");
        }
